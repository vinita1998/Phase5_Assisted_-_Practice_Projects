...
public class AmazonTest {
 ...
 System.setProperty("webdriver.chrome.driver", "D:\\Phase-5\\chromedriver_win32\\chromedriver.exe");
		...
		WebElementmail = driver.findElement(By.id("ap_email"));
		mail.sendKeys("abc@gmail.com");
		mail.submit();
		WebElementpassword = driver.findElement(By.id("ap_password"));
		password.sendKeys("xy1245");
		driver.findElement(By.id("signInSubmit")).click();
		
		WebElementsearchbox = driver.findElement(By.id("twotabsearchtextbox"));
